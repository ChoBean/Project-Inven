			...
			<div id="Content">
				<div id="TAB1">		
					...
					<div id="Wrapper">
						<div id="Navigation">
							<ul class="list-group list-group-horizontal-sm"  id="primary" style="line-height:10px;">
								<li class="list-group-item list-group-item-light"><a href="/userInfo">내가 쓴 글</a></li>
								<li class="list-group-item list-group-item-dark"><a href="/userInfou" class="active">내가 쓴 댓글</a></li>
							</ul>
						</div>
						<div id="Content">
				...
				<div id="TAB2">		
					...
					<table class="table table-bordered">
						...
						<c:forEach var="userBoardUnder" items="${listUnder}" varStatus="loop">
							<tr>
								<td><a href="/readUnder/${userBoardUnder.num1 }">${userBoardUnder.content }</a></td>
								<td>${userBoardUnder.writer }</td>
							</tr>
						</c:forEach>
					</table>
				</div>
